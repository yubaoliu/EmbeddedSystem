...
//包含数据库连接文件
include('conn.php');
$check_query = "select truckid  from DEPARTURE where ic='$IC'";
$truck=mysql_query($check_query,$conn);


$row = mysql_fetch_array($truck);

$result=mysql_query("select * from $row[0] order by time desc");
mysql_query("SET NAMES GB2312");
?>
<div class="gy01">
					<h3>GPS车辆地理信息 Of <?php echo $row[0];?></a>  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="../map.html" target=_blank>电子地图追踪</a></h3>
					<div class="conn">
