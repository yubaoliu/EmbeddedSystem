...
<UL>
   ...
   <LI><A href="swarehouse1.php">站点出库信息</A> </LI>
   <LI><A href="swarehouse2.php">入库车辆信息</A> </LI>
   <LI><A href="gps.html">gps追踪</A> </LI>
...
$result=mysql_query("select * from  SWAREHOUSE1  where intime=''or outtime=''");
