...
//	void PlayAlarmSound;
	int RoomNum;
	CString Address;
	void AppendSaveData(CString CurrentReceiveData);
...
protected:
	...
	afx_msg void OnBUTTONOpenFireAlarm();
	afx_msg void OnSelendokCOMBORoomNum();
	afx_msg void OnBUTTONCloseFireAlarm();
	afx_msg void OnBUTTONOpenThiefAlarm();
	afx_msg void OnBUTTONCloseThiefAlarm();
