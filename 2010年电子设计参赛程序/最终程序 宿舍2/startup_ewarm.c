...
extern void GPIO_Port_E_ISR(void);
extern void GPIO_Port_F_ISR(void);
//extern void GPIO_Port_G_ISR(void);
//*****************************************************************************
//
...
__root const uVectorEntry __vector_table[] @ ".intvec" =
{
    ...
    IntDefaultHandler,                      // GPIO Port D GPIO_Port_D_ISR
    ...
    ADC_Sequence_0_ISR,                      // ADC Sequence 0
    ...
    IntDefaultHandler,                      // GPIO Port G GPIO_Port_G_ISR
